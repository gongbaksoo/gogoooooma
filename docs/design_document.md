...
| Chart | 종류 | 시리즈 | 컬러 매핑 |
|-------|------|--------|-----------|
| 1. 목표비 실적 | BarChart (수직 2개) | 사업계획 / 실적 | 사업계획 `#5d5d5d`, 실적 `#000000`, 달성률(%) 라벨 `#ff0066` |
| 2. 전년비 트렌드 | LineChart (12점) | 당해 / 전년 | 당해 `#000000` 실선, 전년 `#5d5d5d` 점선 |
| 3. 주력 vs 쿠팡사입 | LineChart (12점) | 주력채널 / 쿠팡(사입) | 주력 `#000000`, 쿠팡 `#ff0066` (강조 단일색) |
